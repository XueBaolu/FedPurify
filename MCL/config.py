...
def get_arguments():
    ...
    # various path
    parser.add_argument('--checkpoint_root', type=str, default='./checkpoints/', help='models weight are saved here')
    parser.add_argument('--log_root', type=str, default='./results', help='logs are saved here')
    parser.add_argument('--dataset', type=str, default='cifar10', help='name of image dataset')
    parser.add_argument('--model', type=str, default='./checkpoints/CIFAR10/WRN-16-2/badnets_grid.pth', help='path of student model')
    ...
    parser.add_argument('--t_name', type=str, default='WRN-16-2', help='name of teacher')
    parser.add_argument('--s_name', type=str, default='WRN-16-2', help='name of student')
